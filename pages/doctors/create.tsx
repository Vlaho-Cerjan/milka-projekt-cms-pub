...
const CreateDoctorPage = ({ doctors }: { doctors: doctors[] }) => {
    ...
    return (
        <StyledContainer>
            <SEO page_info={
                {
                    page_slug: "/doctors/create",
                    page_title: "Stranice | Stvori Novog Doktora",
                    page_description: "Stranice | Stvori Novog Doktora",
                    image: "",
                    openGraphType: "website"
                }
            } />
            <Typography component="h1" variant="h4" sx={{ mb: "32px" }}>
                Stvori Novog Doktora
            </Typography>
            <Paper
                component={"form"}
